...
//    private final StompHandler stompHandler;
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("api/policychat").setAllowedOrigins("http://localhost:3000","http://3.36.131.236:443","http://3.36.131.236:80","http://3.36.131.236:3000").withSockJS();
        registry.addEndpoint("api/personalchat").setAllowedOrigins("http://localhost:3000","http://3.36.131.236:443","http://3.36.131.236:80","http://3.36.131.236:3000").withSockJS();
    }
